 ...
 * - Center: Breadcrumbs (Dashboard > Set > Card)
...
import { ArrowLeft, Heart, Bell, ChevronRight } from 'lucide-react'
  ...
  return (
    <header className={cn(
      ...
      >
        {setName && (
          <>
            <span className="text-muted-foreground truncate max-w-[100px] lg:max-w-[150px]">
              {setName}
            </span>
