  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (__privateGet(this, _Component)) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-DymJEvfG-EGJZXAKA.js"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (__privateGet(this, _Component2)) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-BBz1qLry-6FIOEGUD.js").then((n) => n.c));
...
//# sourceMappingURL=chunk-H4V2AXYD.js.map
